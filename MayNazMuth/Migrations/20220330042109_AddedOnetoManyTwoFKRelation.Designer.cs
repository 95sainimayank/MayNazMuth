...
namespace MayNazMuth.Migrations
{
    ...
    [Migration("20220330042109_AddedOnetoManyTwoFKRelation")]
    partial class AddedOnetoManyTwoFKRelation
    {
            ...
            modelBuilder.Entity("MayNazMuth.Entities.Flight", b =>
                {
                    ...
                    b.Property<int?>("DestinationAirportAirlineId")
                        .HasColumnType("int");

                    b.Property<string>("FlightNo")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("SourceAirportAirlineId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DestinationAirportAirlineId");

                    b.HasIndex("SourceAirportAirlineId");
            ...
            modelBuilder.Entity("MayNazMuth.Entities.Flight", b =>
                {
                    ...
                    b.HasOne("MayNazMuth.Airport", null)
                    ...
                    b.HasOne("MayNazMuth.Airline", "DestinationAirport")
                        .WithMany()
                        .HasForeignKey("DestinationAirportAirlineId");

                    b.HasOne("MayNazMuth.Airline", "SourceAirport")
                        .WithMany()
                        .HasForeignKey("SourceAirportAirlineId");
                });
